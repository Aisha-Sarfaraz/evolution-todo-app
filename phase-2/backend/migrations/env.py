...
from src.models.task_tag import TaskTag  # noqa: E402
...
# Get database URL from environment variable and ensure asyncpg driver
database_url = os.getenv("DATABASE_URL", "postgresql+asyncpg://localhost/todo_db")
...
# asyncpg uses connect_args for SSL; add ssl=require via query param
